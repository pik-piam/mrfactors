...
R package **mrfactors**, version **0.7.0**
...
Leip D, Molina Bacca E (2024). _mrfactors: MADRaT based package on factor inputs_. R package version 0.7.0, <URL: https://github.com/pik-piam/mrfactors>.
