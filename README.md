...
R package **mrfactors**, version **0.7.7**
...
Leip D, Molina Bacca E (2025). "mrfactors: MADRaT based package on factor inputs." Version: 0.7.7, <https://github.com/pik-piam/mrfactors>.
