...
R package **mrfactors**, version **0.3.2**
...
Leip D, Molina Bacca E (2023). _mrfactors: MADRaT based package on factor inputs_. R package version 0.3.2, <URL: https://github.com/pik-piam/mrfactors>.
