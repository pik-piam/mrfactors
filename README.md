...
R package **mrfactors**, version **0.5.4**
...
Leip D, Molina Bacca E (2024). _mrfactors: MADRaT based package on factor inputs_. R package version 0.5.4, <URL: https://github.com/pik-piam/mrfactors>.
