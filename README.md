...
R package **mrfactors**, version **0.4.0**
...
Leip D, Molina Bacca E (2024). _mrfactors: MADRaT based package on factor inputs_. R package version 0.4.0, <https://github.com/pik-piam/mrfactors>.
