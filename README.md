...
R package **mrfactors**, version **0.10.0**
...
Leip D, Molina Bacca E (2026). "mrfactors: MADRaT based package on factor inputs." Version: 0.10.0, <https://github.com/pik-piam/mrfactors>.
