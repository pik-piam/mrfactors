...
R package **mrfactors**, version **0.8.1**
...
Leip D, Molina Bacca E (2025). "mrfactors: MADRaT based package on factor inputs." Version: 0.8.1, <https://github.com/pik-piam/mrfactors>.
