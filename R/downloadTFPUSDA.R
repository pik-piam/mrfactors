...
downloadTFPUSDA <- function() {
  ...
  return(list(
    url          = "https://www.ers.usda.gov/webdocs/DataFiles/51270/AgTFPInternational2019.xlsx?v=263.4",
    doi          = "not available",
    ...
    description   = "One of the most informative measures of agricultural productivity is total factor productivity
    (TFP). TFP takes into account all of the land, labor, capital, and material resources employed in farm production
    and compares them with the total amount of crop and livestock output.",
